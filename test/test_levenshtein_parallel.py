...
class MyTestCase(unittest.TestCase):
    def test_case_insensitive(self) -> None:
        ...
        # First search
        results = g.search_parallel('Poimt of sales'.lower(), nbest=0)
        ...
        # Second search
        results = g.search_parallel('point of sale'.lower(), nbest=0)
        self.assertEqual(len(results), 1)
        self.assertEqual(results[0][0], 'point of sale')
        ...
        self.assertEqual(str(results[0][2]), path)
        # Third search
        results = g.search_parallel('poit of sal'.lower(), nbest=0)
        self.assertEqual(len(results), 1)
        self.assertEqual(results[0][0], 'point of sale')
        self.assertEqual(results[0][1], 2.0)
        ...
        self.assertEqual(str(results[0][2]), path)
        results = g.search_parallel('punto', nbest=0)
    ...
    #     g.index(TERMS)
    #     # First search
    #     results = g.search_parallel('Poimt of sales', nbest=0)
    #     self.assertEqual(len(results), 0)
    #     # Second search
    #     results = g.search_parallel('Poimt of sale', nbest=0)
    #     self.assertEqual(len(results), 1)
    ...
    #     results = tree.search_parallel('Poi ntof-sales'.lower(), nbest=0)
    ...
    #     results = g.search_parallel('Poimt of sales'.lower(), threshold=0.8, nbest=0)
    #     self.assertEqual(len(results), 1)
    #     self.assertEqual(results[0][0], 'point of sale')
    #     self.assertEqual(results[0][1], 2.0)
    #     path = '[(None), (None), (None), (replace[m -> n], 1), (None), (None), (None), (None), (None), (None), ' \
    ...
    #     # Change the preprocess method
    #     results = g.search_parallel('Poimt of sales'.upper(), threshold=0.8, nbest=0)
    #     self.assertEqual(len(results), 1)
    #     self.assertEqual(results[0][0], 'POINT OF SALE')
    #     self.assertEqual(results[0][1], 2.0)
    #     path = '[(None), (None), (None), (replace[M -> N], 1), (None), (None), (None), (None), (None), (None), ' \
    ...
    #     g.index(TERMS)
    #     # Change the preprocess method
    #     results = g.search_parallel('Poimt of sales', threshold=0.75, nbest=0)
    #     self.assertEqual(len(results), 1)
    #     self.assertEqual(results[0][0], 'point of sale')
    ...
    #     term = ["h", "ɛ", "l", "əʊ"]
    #     results = g.search_parallel(term)
    ...
    #     results = g.search_parallel(['point', 'sales'])
